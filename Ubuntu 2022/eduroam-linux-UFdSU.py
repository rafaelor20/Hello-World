...
Messages.quit = "Tem a certeza que pretende desistir?"
Messages.username_prompt = "introduza o seu userid"
Messages.enter_password = "escrever a palavra passe"
Messages.enter_import_password = "coloque a sua palavra passe " \
    "importada"
Messages.incorrect_password = "palavra passe incorreta"
Messages.repeat_password = "repita a sua password"
Messages.passwords_differ = "as passwords não coincidem"
Messages.installation_finished = "Instalação realizada com sucesso"
Messages.cat_dir_exisits = "A diretoria {} existe; alguns ficheiros " \
    "podem ser sobrepostos"
Messages.cont = "Continuar?"
Messages.nm_not_supported = "Esta versão do NetworkManager não é " \
    "suportada"
Messages.cert_error = "O ficheiro de certificado não foi encontrado, " \
    "parece ser um erro do CAT"
Messages.unknown_version = "Versão desconhecida"
Messages.dbus_error = "Problema de ligação DBus, um sudo pode " \
    "ajudar"
Messages.yes = "S"
Messages.no = "N"
Messages.p12_filter = "ficheiro do certificado pessoal (p12 ou pfx)"
Messages.all_filter = "Todos os ficheiros"
Messages.p12_title = "ficheiro do certificado pessoal (p12 ou pfx)"
Messages.save_wpa_conf = "A configuração do NetworkManager falhou, " \
    "mas podemos criar um ficheiro de configuração wpa_supplicant se " \
    "pretender. Tenha em atenção que a sua palavra passe de ligação " \
    "irá ser guardada neste ficheiro como texto visível."
Messages.save_wpa_confirm = "Escreva o ficheiro"
Messages.wrongUsernameFormat = "Erro: O seu nome de utilizador deve " \
    "ser no formato 'xxx@institutionID' por exemplo 'john@example.net'!"
Messages.wrong_realm = "Erro: o seu nome de utilizador deve estar no " \
    "formato de 'xxx@{}'. Por favor escreva o nome de utilizador no formato " \
    "correto."
Messages.wrong_realm_suffix = "Erro: o seu nome de utilizador tem de " \
    "estar na forma 'xxx@institutionID' e terminar com '{}'. Por favor " \
    "coloque o nome de utilizador no formato correto."
Messages.user_cert_missing = "ficheiro do certificado pessoal não " \
    "encontrado"
Config.instname = "Universidade Federal de Sergipe (UFS)"
Config.profilename = "Eduroam-UFS"
Config.url = "http://redes.ufs.br"
Config.email = "eduroam@ufs.br"
Config.title = "eduroam CAT"
Config.server_match = "pirambu.ufs.br"
Config.eap_outer = "PEAP"
Config.eap_inner = "MSCHAPV2"
Config.init_info = "O instalador foi preparado para {0}\n\nMais " \
    "informações e comentários:\n\nEMAIL: {1}\nWWW: {2}\n\nInstalador " \
    "criado com software do projecto GEANT."
Config.init_confirmation = "Este instalador apenas funcionará da " \
    "forma correta se for membro de {0}"
Config.user_realm = "ufs.br"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:pirambu.ufs.br']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
run_installer()
